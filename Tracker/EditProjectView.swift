...
//  Tracker
//
//  Created by Chris Bata on 11/10/20.
//
...
struct EditProjectView: View {
    ...
    var body: some View {
        Form {
            ...
            Section(footer: Text("Closing a project moves it from the Open to the Closed tab; deleting it removes the project entirely")) {
